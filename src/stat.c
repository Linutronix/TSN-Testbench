                                       ...
                                       bool outOfOrder, bool payloadMismatch, bool frameIdMismatch)
{
    ...
    /*
     * Test if the amount of time specified in the config is arrived.  if true this will be the last point to be taken
     * into stats per period
     */
    ...
    /*
     * Final bits can be used in the logger reseting copying actual values and reseting the preparation
     */
